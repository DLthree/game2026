 ...
 * @typedef {{pos: Vector2, vel: Vector2, radius: number, color: string}} Circle
 * @typedef {{pos: Vector2, vel: Vector2, size: number, color: string, health: number}} Square
 * @typedef {{pos: Vector2, vel: Vector2, size: number, color: string}} Triangle
 */
...
const healthElement = /** @type {HTMLElement} */ (document.getElementById('health'));
...
const game = {
    ...
    enemies: /** @type {Square[]} */ ([]),
    projectiles: /** @type {Triangle[]} */ ([]),
    score: 0,
    health: 100,
    isGameOver: false,
    lastEnemySpawn: 0,
    lastShot: 0,
    targetPos: /** @type {Vector2|null} */ (null)
};
